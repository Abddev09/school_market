        ...
        <div className="flex flex-col h-full text-gray-200 bg-[#111]/90 backdrop-blur-sm border-r border-white/10">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `group flex items-center gap-3 max-md:gap-2 w-full px-4 max-md:px-3 py-3 max-md:py-2.5 rounded-lg transition-colors duration-200 ${
                    isActive
                      ? "bg-linear-to-r from-yellow-400 to-yellow-300 text-black shadow-[0_6px_20px_rgba(212,175,55,0.16)] font-semibold"
          ...
          <div className="px-4 max-md:px-3 py-4 max-md:py-3 border-t border-white/5">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2 max-md:py-1.5 rounded-md bg-linear-to-r from-yellow-400 to-yellow-300 text-black font-semibold text-sm max-md:text-xs shadow hover:scale-[1.02] transition-transform"
            >
              Chiqish
            </button>
            ...
            >
              ...
              <div className="flex justify-center gap-4 max-md:gap-3">
                <button
                  ...
                  className="bg-linear-to-r from-yellow-400 to-yellow-300 text-black font-semibold py-2 max-md:py-1.5 px-6 max-md:px-5 text-sm max-md:text-xs rounded-lg hover:scale-[1.03] transition-transform"
                >
                  Ha
                </button>
                <button
